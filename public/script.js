...
async function loadGallery() {
  ...
  try {
    ...
    if (photos.length === 0) {
      grid.innerHTML = '<p style="color:rgba(255,255,255,0.4);text-align:center;grid-column:1/-1;padding:40px 0">Belum ada foto 🌸</p>';
      galleryImgs = [];
      return;
    }
    ...
    galleryImgs = Array.from(grid.querySelectorAll('img'));
  } catch (err) {
    grid.innerHTML = '<p style="color:rgba(255,255,255,0.4);text-align:center;grid-column:1/-1;padding:40px 0">Gagal memuat foto 😢</p>';
  }
}
